window.onload = function(){
    ...
    function setText(topText, middleText, bottomText){
        ...
        var middleTextFont = `normal 400 ${middleTextSize}px/2 Vazirmatn`;
        ...
        function iterate(callback){
            ...
            g.translate(margin + (canvas.width - metrics.width - margin * 2.0) * 0.5, margin);
            var x = 0;
        ...
        var topColors = ["#8f0354", "#04ad8f", "#2782c4", "#a6ce48", "#f3a118", "#ea6435", "#17b297", "#e30983", "#1aa6e7", "#8f0354", "#f29905", "#e50011", "#ccdc26", "#a5328d", "#0aaa60", "#91c423", "#f29300", "#ec5f69", "#22b69e", "#e63e9b", "#917220"];
        ...
        // stroke outline
        g.font = middleTextFont;
        g.strokeStyle = "#0B3F30";
        g.lineWidth = 7.0;
        g.shadowColor = "#000";	
        g.shadowBlur = 2;
        g.lineCap = "round";
        g.lineJoin = "round";
        g.strokeText(middleText, 3, 4);
    ...
    middleInput.value = "كِلَاسِيكِيٌّ";
